...
EXECUTABLE     := $(CONAN_BUILD_DIR)/bin/box2d_demo
...
help:
	@echo "$(CYAN)╔════════════════════════════════════════════╗$(NC)"
	@echo "$(CYAN)║        Box2D Demo - Build System         ║$(NC)"
	@echo "$(CYAN)╚════════════════════════════════════════════╝$(NC)"
	@echo ""
	...
	@echo "  $(GREEN)make run$(NC)       - Executa a simulação"
...
init:
	@echo "$(BLUE)>>> 📦 Instalando Box2D com Conan...$(NC)"
...
run:
	...
	@echo "$(CYAN)>>> 🚀 Executando simulação Box2D$(NC)"
	$(EXECUTABLE)
